...
class _CareersPageState extends State<CareersPage> with TickerProviderStateMixin {
  ...
  final Map<String, Map<String, List<String>>> _countryData = {
    ...
    "Mexico": {
      ...
      "México": ["Toluca", "Ecatepec", "Naucalpan"],
...
class _NeonInput extends StatelessWidget {
  ...
  // Italian/Mexican 5-digit CAP/C.P. codes, Argentine codes like
  // "C1425AAA", etc.) uses letters, digits, and spaces in varying
  // lengths — so only enforce the strict US pattern when the US is
  // actually selected.
